...
<nav class="white">
    ...
    <section class="container" style="margin-top:10px">
        <div class="card-panel">
            ...
            <h4>Recruiter Account</h4>
        
          <form action="/dashboard/create-company" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="input-field col s12 m6">
                  <input name="name" id="disabled" value="{{old('name')}}" type="text" class="validate">
                  <label for="disabled">Company Name</label>
                    ...
                    <div class="input-field col s12 m6">
                      <input name="email" id="disabled2" value="{{old('email')}}" type="email" class="validate">
                  ...
                  @endif
                    ...
                    <div class="input-field col s12 m6">
                        <input name="physical_address" id="disabled3" value="{{old('physical_address')}}" type="text" class="validate">
                    ...
                    @endif
                      ...
                      <div class="input-field col s12 m6">
                        <input name="postal_address" id="disabled3x" value="{{old('postal_address')}}" type="text" class="validate">
                    ...
                    @endif
                      ...
                      <div class="input-field col s12 m6">
                        <input name="phone" id="disabled3xb" value="{{old('phone')}}" min=308111 type="number" class="validate">
                    ...
                    @endif
                      ...
                      <div class="input-field col s12 m6">
                      <textarea name="bio" id="textarea1" class="materialize-textarea">{{old('bio')}}</textarea>
